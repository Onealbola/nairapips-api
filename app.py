...
def approve_payment():
    ...
    try:
        ...
        if data.get("balance"):
            ...
            balance_raw = str(data.get("balance"))
...
def get_support_tickets():
    ...
    try:
        ...
        print("GET SUPPORT TICKETS ERROR:", repr(e))
